...
static yyconst flex_uint16_t yy_base[21] =
    {   0,
        0,    8,   23,   24,   14,   18,   24,   14,   11,    8,
        6,    4,    0,    0,    0,   24,   24,   24,   24,    0
    } ;
...
static yyconst flex_uint16_t yy_nxt[36] =
    {   0,
        4,   18,   17,    5,   19,   19,   19,   19,    6,   16,
        7,    5,   15,   14,   13,   12,    6,   11,    7,    8,
        9,   10,   19,    3,   19,   19,   19,   19,   19,   19,
       19,   19,   19,   19,   19
    } ;

static yyconst flex_int16_t yy_chk[36] =
    {   0,
       20,   15,   14,    1,    0,    0,    0,    0,    1,   13,
        1,    2,   12,   11,   10,    9,    2,    8,    2,    5,
        5,    6,    3,   19,   19,   19,   19,   19,   19,   19,
       19,   19,   19,   19,   19
    } ;
...
YY_RULE_SETUP
#line 39 "scanner.l"
{ printf( "A lone capital %s %u\n", yytext, strlen(yytext) ); }
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 41 "scanner.l"
{ /* Integers without superfluous leading zeros */ }
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 44 "scanner.l"
...
YY_RULE_SETUP
#line 47 "scanner.l"
{ /* C (C++, Java?) floating point specification */ }
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 50 "scanner.l"
